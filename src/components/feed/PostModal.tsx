...
export function PostModal({ post: initialPost, onClose, onProfileClick, onDeleted }: PostModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-100 dark:border-neutral-800 w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col animate-scale-in"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scroll flex flex-col">
          ...
          <div className="p-4 space-y-3">
            ...
            {/* Comments */}
            {showComments && (
              <div className="space-y-2 pt-2 border-t border-gray-100 dark:border-neutral-800 animate-fade-in">
        ...
        {/* Comment input */}
        {showComments && (
          <div className="flex items-center gap-2 p-4 border-t border-gray-100 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-800/50 shrink-0">
            ...
            <input
              ...
              className="flex-1 bg-white dark:bg-neutral-800 rounded-full px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-brand-500 border border-transparent focus:border-transparent"
            />
            {commentText.trim() && (
        ...
        {showReport && (
          <div
            className="absolute inset-0 flex items-center justify-center bg-black/50 p-4 rounded-2xl"
